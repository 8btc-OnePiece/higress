...
if [ $? -eq 0 ]; then
    ...
    echo "   docker build -t ai-statistics:1.0.0 ."
    echo ""
    echo "2. Push to registry:"
    echo "   docker tag ai-statistics:1.0.0 your-registry/ai-statistics:1.0.0"
    echo "   docker push your-registry/ai-statistics:1.0.0"
    echo ""
    echo "3. Configure in Higress:"
    echo "   Use image: your-registry/ai-statistics:1.0.0"
else
    echo ""
    echo "Build failed!"
    exit 1
