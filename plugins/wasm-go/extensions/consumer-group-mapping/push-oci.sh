...
# Consumer Group Mapping Plugin - OCI 镜像推送脚本
# 使用 ORAS 将插件推送到 OCI 镜像仓库

set -e

echo "========================================="
echo "Pushing Consumer Group Mapping Plugin"
...
# 配置变量（可通过环境变量覆盖）
PLUGIN_NAME="${PLUGIN_NAME:-consumer-group-mapping}"
VERSION="${VERSION:-1.0.0}"
IMAGE_REGISTRY_SERVICE="${IMAGE_REGISTRY_SERVICE:-docker.io}"
