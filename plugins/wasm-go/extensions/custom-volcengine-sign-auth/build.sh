...
# Volcengine Sign Auth Plugin 构建脚本
# 支持 Go 1.24 原生编译和 TinyGo 编译两种方式

set -e

echo "========================================="
echo "Building Volcengine Sign Auth Plugin"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo "   docker build -t volcengine-sign-auth:1.0.0 ."
    echo ""
    echo "2. Push to registry:"
    echo "   docker tag volcengine-sign-auth:1.0.0 your-registry/volcengine-sign-auth:1.0.0"
    echo "   docker push your-registry/volcengine-sign-auth:1.0.0"
    echo ""
    echo "3. Configure in Higress:"
    echo "   Use image: your-registry/volcengine-sign-auth:1.0.0"
else
    echo ""
    echo "Build failed!"
    exit 1
